...
[Главная фича](#в-чём-главная-фича) - [Установка](#установка) - [Настройка](#настройка) - [Доступные миксины](#доступные-миксины)
...
## Доступные миксины
### grid-media($bp-code)
Добавить набор стилей к определённому брейкпоинту
```scss
